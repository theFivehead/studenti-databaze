...
public class main {
    ...
    public static void main(String[] args) {
        ...
        Student s1 = new Student("Jan", "Novák", LocalDate.of(2004, 3, 15), 1);
        Student s2 = new Student("Eva", "Dvořáková", LocalDate.of(2003, 7, 22), 2);
        Student s3 = new Student("Petr", "Svoboda", LocalDate.of(2005, 1, 10), 1);
        Student s4 = new Student("Lucie", "Králová", LocalDate.of(2004, 11, 5), 2);
        Student s5 = new Student("Tomáš", "Horák", LocalDate.of(2003, 6, 30), 1);
        Student s6 = new Student("Jan", "Arnost", 1001, LocalDate.of(2002, 3, 15), 1);
        Student s7 = new Student("Jan", "Zebra", LocalDate.of(2003, 3, 15), 1);
    	...
    	databaze.vypsat_studenty();
    	*/
    	SqliteDatabaze.ulozit_data("testefg",databaze);
    	Databaze_studentu databaze_sql=SqliteDatabaze.nacist_data("testefg");
    	System.out.println(databaze.vypsat_studenty());
    	System.out.println(databaze_sql.vypsat_studenty());
    }
}
